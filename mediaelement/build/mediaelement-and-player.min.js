...
!(function r(a, s, l) {
...
})(
  {
        ...
        var i = function e(t, n, o) {
              ...
              case "video":
                ...
                if (u) {
                  var p = f.mediaElement.originalNode,
                    m = (0, M.formatType)(u, p.getAttribute("type"));
                ...
                for (var h = 0; h < d; h++) {
                  ...
                  if ("source" === v.tagName.toLowerCase()) {
                    var g = v.getAttribute("src"),
                      y = (0, M.formatType)(g, v.getAttribute("type"));
          ...
          (f.mediaElement.id = i),
            ...
            (f.mediaElement.generateError = function (e, t) {
              ...
              var n = (0, O.createEvent)("error", f.mediaElement);
              (n.message = e),
                (n.urls = t),
          ...
          var E = j.default.html5media.properties,
            ...
            P = function (e) {
              var t = [];
              if ("string" == typeof e)
                t.push({ src: e, type: e ? (0, M.getTypeFromFile)(e) : "" });
              else if (
                "object" === (void 0 === e ? "undefined" : L(e)) &&
                void 0 !== e.src
              ) {
                var n = (0, M.absolutizeUrl)(e.src),
                  o = e.type,
                  i = Object.assign(e, {
                    src: n,
                    type:
                      ("" !== o && null != o) || !n
                        ? o
                        : (0, M.getTypeFromFile)(n),
                  });
                t.push(i);
              } else if (Array.isArray(e))
                for (var r = 0, a = e.length; r < a; r++) {
                  var s = (0, M.absolutizeUrl)(e[r].src),
                    l = e[r].type,
                    d = Object.assign(e[r], {
                      src: s,
                      type:
              ...
              if (
                (f.mediaElement.paused ||
                  ...
                  (c = (0, O.createEvent)("pause", f.mediaElement)),
          ...
          for (var N = 0, A = b.length; N < A; N++) T(b[N]);
          return (
    ...
    14: [
        ...
        Object.assign(o.config, {
          ...
          Object.assign(i.default.prototype, {
              ...
              if (
                ...
                t.hideAllTracks(),
                  ...
                  (o.captionsButton.innerHTML =
                    ...
                    "</label></li></ul></div>"),
                  t.addControlElement(o.captionsButton, "tracks"),
                  (o.captionsButton.querySelector(
                    "." + t.options.classPrefix + "captions-selector-input"
                  ).disabled = !1),
                  (o.chaptersButton = g.default.createElement("div")),
                ...
                var r = t.getSubtitles();
                0 < t.getChapters().length &&
                  !e.querySelector(
                ...
                for (var a = 0; a < r.length; a++)
                  o.addTrackButton(r[a]),
                    r[a].isLoaded && t.enableTrackButton(r[a]);
                (o.trackToLoad = -1),
                  (o.selectedTrack = null),
                  (o.isLoadingTrack = !1);
                var s = ["mouseenter", "focusin"],
                  l = ["mouseleave", "focusout"];
                if (t.options.toggleCaptionsButtonWhenOnlyOne && 1 === r.length)
                  o.captionsButton.addEventListener("click", function (e) {
                    var t = "none";
                    null === o.selectedTrack &&
                      (t = o.getSubtitles()[0].trackId);
                    var n = e.keyCode || e.which;
                    o.setTrack(t, void 0 !== n);
                  });
                else {
                  for (
                    var d = o.captionsButton.querySelectorAll(
                    ...
                    o.captionsButton.addEventListener(s[c], function () {
                      (0,
                      b.removeClass)(this.querySelector("." + t.options.classPrefix + "captions-selector"), t.options.classPrefix + "offscreen");
                    });
                  for (var f = 0; f < l.length; f++)
                    o.captionsButton.addEventListener(l[f], function () {
                      var e = this;
                      setTimeout(function () {
                        (0,
                        b.addClass)(e.querySelector("." + t.options.classPrefix + "captions-selector"), t.options.classPrefix + "offscreen");
                      }, 0);
                    });
                  for (var p = 0; p < u.length; p++)
                    u[p].addEventListener("click", function (e) {
                      var t = e.keyCode || e.which;
                      e.target.disabled || o.setTrack(this.value, void 0 !== t);
                    });
                  for (var m = 0; m < d.length; m++)
                    d[m].addEventListener("click", function (e) {
                ...
                for (var h = 0; h < s.length; h++)
                  o.chaptersButton.addEventListener(s[h], function () {
                    this.querySelector(
                ...
                for (var v = 0; v < l.length; v++)
                  o.chaptersButton.addEventListener(l[v], function () {
                    var e = this;
                    setTimeout(function () {
                      (0,
                      b.addClass)(e.querySelector("." + t.options.classPrefix + "chapters-selector"), t.options.classPrefix + "offscreen");
                    }, 0);
                  });
            ...
            rebuildtracks: function () {
              var e = this;
              e.findTracks(), e.buildtracks(e, e.getElement(e.controls));
            },
            ...
            setTrack: function (e, t) {
              ...
              r.checked = !0;
              for (
                var l = (0, b.siblings)(r, function (e) {
                    return (0,
              ...
              if ("none" === e)
                (n.selectedTrack = null),
                  ...
                  n.deactivateVideoTracks();
              else {
                var u = n.getTrackById(e);
                u &&
                  ...
                  (n.selectedTrack = u),
                  n.activateVideoTrack(n.selectedTrack.srclang));
              }
              var c = (0, E.createEvent)("captionschange", n.media);
              (c.detail.caption = n.selectedTrack),
                n.media.dispatchEvent(c),
                t ||
                  setTimeout(function () {
            ...
            hideAllTracks: function () {
              if (this.domNode.textTracks)
                for (var e = 0; e < this.domNode.textTracks.length; e++)
                  this.domNode.textTracks[e].mode = "hidden";
            },
            deactivateVideoTracks: function () {
              if (this.domNode.textTracks)
                for (var e = 0; e < this.domNode.textTracks.length; e++) {
                  var t = this.domNode.textTracks[e];
                  ("subtitles" !== t.kind && "captions" !== t.kind) ||
                    (t.mode = "hidden");
                }
            },
            activateVideoTrack: function (e) {
              for (var t = 0; t < this.domNode.textTracks.length; t++) {
                var n = this.domNode.textTracks[t];
            ...
            drawChapters: function (e) {
              var i = this,
                t = this.domNode.textTracks.getTrackById(e),
                n = t.cues.length;
              if (n) {
      ...
      { 17: 17, 2: 2, 27: 27, 28: 28, 29: 29, 6: 6, 8: 8 },
    ],
    15: [
      function (e, t, n) {
        "use strict";
                  ...
                  if (
                    ...
                    l.isDynamic
                      ...
                      : (function () {
                          ...
                          "" !==
                            l.media.canPlayType((0, m.getTypeFromFile)(u)) &&
      ...
      function (e, t, n) {
        ...
        var r = (n.PluginDetector = {
          ...
          detectPlugin: function (e, t, n, o) {
            ...
            } else if (void 0 !== T.default.ActiveXObject)
              try {
        ...
        var i = {
          create: function (e, t, n) {
            ...
            (T.default["__ready__" + r.id] = function () {
              if (
                ((r.flashReady = !0),
              ...
              (T.default["__event__" + r.id] = function (e, t) {
    ...
    26: [
      function (e, t, n) {
        ...
        for (
          ...
          x = r.default.createElement(w[P]);
        var T = (n.SUPPORTS_NATIVE_HLS = g || (p && /edge/i.test(l))),
        ...
        (n.isFullScreen = O),
          ...
          (o.default.Features.isFullScreen = O),
          (o.default.Features.requestFullScreen = M),
