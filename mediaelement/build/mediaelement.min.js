...
!(function a(o, l, s) {
...
})(
  {
        ...
        (function (e) {
          ...
          "undefined" != typeof document
            ...
            : (t = n["__GLOBAL_DOCUMENT_CACHE@4"]) ||
              (t = n["__GLOBAL_DOCUMENT_CACHE@4"] = r),
            (a.exports = t);
        }.call(
          this,
                ...
                (function e() {
                  for (var t = 0; t < p.length; ) {
                    ...
                    if (
                      (!a &&
                        c.attributeName &&
                        (a = n.getAttribute(c.attributeName)),
                      i && a)
                    ) {
                      if (u)
                        if (!c.validate || c.validate(a, i, n)) {
                          r.removeChild(n);
                          var o = a.split("#"),
                            l = o.shift(),
                            s = o.join("#");
                          if (l.length) {
                            var d = f[l];
                            d ||
                              ((d = f[l] = new XMLHttpRequest()).open("GET", l),
                              d.send(),
                              (d._embeds = [])),
                              d._embeds.push({ parent: r, svg: i, id: s }),
                              g(d);
                          } else v(r, i, document.getElementById(s));
                        } else ++t, ++h;
                    } else ++t;
                  }
      ...
      function (e, t, n) {
            ...
            if ("string" == typeof e && e.length) {
              ...
              return (
                void 0 !== d[i] &&
                  ...
                  null !== t &&
                    "number" == typeof t &&
                    ((r = d[i]["mejs.plural-form"]),
                    (n = a.apply(null, [n, t, r])))),
                !n &&
                  d.en &&
                  ((n = d.en[e]),
                  null !== t &&
                    "number" == typeof t &&
                    ((r = d.en["mejs.plural-form"]),
                    (n = a.apply(null, [n, t, r])))),
                (n = n || e),
        ...
        (a.default.i18n = d),
          "undefined" != typeof mejsL10n &&
            a.default.i18n.language(mejsL10n.language, mejsL10n.strings),
          (n.default = d);
      },
      { 10: 10, 19: 19, 8: 8 },
    ],
    7: [
      function (e, t, n) {
        ...
        var i = function e(t, n, r) {
          ...
          var l = function (t, e) {
              if (
                "https:" === C.default.location.protocol &&
                0 === t.indexOf("http:") &&
                R.IS_IOS &&
                ...
                (n.onreadystatechange = function () {
                  if (4 === this.readyState && 200 === this.status) {
                    var e = (
                      C.default.URL || C.default.webkitURL
          ...
          if (null !== r) s = r;
            ...
            switch (
              ((s = []), f.mediaElement.originalNode.nodeName.toLowerCase())
            ) {
              case "iframe":
                s.push({
                  type: "",
          ...
          (f.mediaElement.id = i),
            ...
            (f.mediaElement.changeRenderer = function (e, t) {
              ...
              for (
                ...
                var d = o[l];
                if (d === e) {
                  a = M.renderer.renderers[d];
                  var u = Object.assign(a.options, n.mediaElement.options);
                  return (
                    ((i = a.create(n.mediaElement, u, t)).name = e),
                    (n.mediaElement.renderers[a.name] = i),
                    (n.mediaElement.renderer = i),
                    (n.mediaElement.rendererName = e),
                    i.show(),
                    !0
          ...
          var E = I.default.html5media.properties,
            ...
            A = function (e, t) {
              try {
                ...
                throw (f.mediaElement.generateError(e, s), e);
              }
            },
            j = function (r) {
          ...
          w(f.mediaElement, "src", S, N),
            (f.mediaElement.getSrc = S),
            (f.mediaElement.setSrc = N);
          for (var T = 0, F = E.length; T < F; T++) _(E[T]);
          for (var P = 0, x = b.length; P < x; P++) j(b[P]);
          return (
            ...
            (f.mediaElement.removeEventListener = function (e, t) {
              ...
              for (var r = 0; r < n.length; r++)
                if (n[r] === t)
                  return f.mediaElement.events[e].splice(r, 1), !0;
              return !1;
            }),
        ...
        (C.default.MediaElement = i),
          (I.default.MediaElement = i),
          (n.default = i);
      },
      { 17: 17, 19: 19, 2: 2, 20: 20, 3: 3, 8: 8, 9: 9 },
    ],
    8: [
      function (e, t, n) {
        "use strict";
        ...
        (((r = i) && r.__esModule ? r : { default: r }).default.mejs = a),
          (n.default = a);
      },
      { 3: 3 },
    ],
    ...
    11: [
              ...
              return (
                "undefined" != typeof dashjs
                  ...
                  : ((e.options.path =
                    ...
                    (A.promise =
                      A.promise || (0, a.loadScript)(e.options.path)),
          ...
          l = {
            ...
            create: function (l, s, e) {
              ...
              for (
                  ...
                  p = function (i) {
                    ...
                    (d["get" + e] = function () {
                      ...
                      (d["set" + e] = function (e) {
                        if (
                          -1 ===
                          _.default.html5media.readOnlyProperties.indexOf(i)
                        )
                          if ("src" === i) {
                            var t =
                              "object" ===
                            ...
                            if (((d[i] = t), null !== u)) {
                              ...
                              (u = A._createPlayer({ options: s.dash, id: a })),
                                e &&
                                  "object" ===
                ...
                p(c[h]);
              if (
                ((w.default["__ready__" + a] = function (e) {
                  l.dashPlayer = u = e;
                  for (
                    var t, n = dashjs.MediaPlayer.events, r = 0, i = f.length;
                    r < i;
                    r++
                  )
                ...
                for (var g = 0, y = e.length; g < y; g++)
                  if (S.renderer.renderers[s.prefix].canPlayType(e[g].type)) {
                    d.setAttribute("src", e[g].src),
                      void 0 !== e[g].drm && (s.dash.drm = e[g].drm);
                    break;
                  }
              d.setAttribute("id", a),
              ...
              return (
                l.dispatchEvent(E),
                l.promises.push(A.load({ options: s.dash, id: a })),
                d
              );
            },
          };
      ...
      { 17: 17, 18: 18, 19: 19, 20: 20, 3: 3, 8: 8, 9: 9 },
    ],
    12: [
      function (e, t, n) {
        "use strict";
        ...
        var a = (n.PluginDetector = {
          ...
          addPlugin: function (e, t, n, r, i) {
            a.plugins[e] = a.detectPlugin(t, n, r, i);
          },
          detectPlugin: function (e, t, n, r) {
            ...
            if (
              ...
              "object" === d(C.NAV.plugins[e])
            ) {
              if (
                (a = C.NAV.plugins[e].description) &&
                ...
                for (
                  ...
                  i[l] = parseInt(i[l].match(/\d+/), 10);
            } else if (void 0 !== j.default.ActiveXObject)
              try {
                (o = new ActiveXObject(n)) && (i = r(o));
              } catch (e) {}
            return i;
          },
        });
        ...
        var i = {
          create: function (e, t, n) {
            var a = {},
              r = !1;
            (a.options = t),
              (a.id = e.id + "_" + a.options.prefix),
              (a.mediaElement = e),
              (a.flashState = {}),
              (a.flashApi = null),
              (a.flashApiStack = []);
            for (
              var i = F.default.html5media.properties,
                o = function (t) {
                  a.flashState[t] = null;
                  var e = "" + t.substring(0, 1).toUpperCase() + t.substring(1);
                  (a["get" + e] = function () {
                    if (null !== a.flashApi) {
                      if ("function" == typeof a.flashApi["get_" + t]) {
                        var e = a.flashApi["get_" + t]();
                        return "buffered" === t
                          ? {
                              start: function () {
                                return 0;
                    ...
                    (a["set" + e] = function (e) {
                      if (
                        ("src" === t && (e = (0, O.absolutizeUrl)(e)),
                        null !== a.flashApi &&
                          void 0 !== a.flashApi["set_" + t])
                      )
                        try {
                          a.flashApi["set_" + t](e);
                        } catch (e) {}
                      else
                        a.flashApiStack.push({
                          type: "set",
                          propName: t,
                          value: e,
                        });
            ...
            var d = F.default.html5media.methods,
              u = function (e) {
                a[e] = function () {
                  if (r)
                    if (null !== a.flashApi) {
                      if (a.flashApi["fire_" + e])
                        try {
                          a.flashApi["fire_" + e]();
                        } catch (e) {}
                    } else
                      a.flashApiStack.push({ type: "call", methodName: e });
                };
              };
            d.push("stop");
            for (var c = 0, f = d.length; c < f; c++) u(d[c]);
            for (var m = ["rendererready"], p = 0, h = m.length; p < h; p++) {
              var v = (0, L.createEvent)(m[p], a);
              e.dispatchEvent(v);
            }
            (j.default["__ready__" + a.id] = function () {
              if (
                ((a.flashReady = !0),
                (a.flashApi = T.default.getElementById("__" + a.id)),
                a.flashApiStack.length)
              )
                for (var e = 0, t = a.flashApiStack.length; e < t; e++) {
                  var n = a.flashApiStack[e];
                  if ("set" === n.type) {
                    var r = n.propName,
                      i = "" + r.substring(0, 1).toUpperCase() + r.substring(1);
                    a["set" + i](n.value);
                  } else "call" === n.type && a[n.methodName]();
                }
            }),
              (j.default["__event__" + a.id] = function (e, t) {
                var n = (0, L.createEvent)(e, a);
                if (t)
                  try {
                ...
                a.mediaElement.dispatchEvent(n);
              }),
              (a.flashWrapper = T.default.createElement("div")),
              -1 ===
                ["always", "sameDomain"].indexOf(a.options.shimScriptAccess) &&
                (a.options.shimScriptAccess = "sameDomain");
            var g = e.originalNode.autoplay,
              y = [
                "uid=" + a.id,
                "autoplay=" + g,
                "allowScriptAccess=" + a.options.shimScriptAccess,
            ...
            e.originalNode.getAttribute("src") &&
              ...
              !0 === a.options.enablePseudoStreaming &&
                (y.push(
                  "pseudostreamstart=" +
                    a.options.pseudoStreamingStartQueryParam
                ),
                y.push("pseudostreamtype=" + a.options.pseudoStreamingType)),
              a.options.streamDelimiter &&
                y.push(
                  "streamdelimiter=" +
                    encodeURIComponent(a.options.streamDelimiter)
                ),
              a.options.proxyType && y.push("proxytype=" + a.options.proxyType),
              e.appendChild(a.flashWrapper),
              (e.originalNode.style.display = "none");
            var _ = [];
            if (C.IS_IE || C.IS_EDGE) {
              var S = T.default.createElement("div");
              a.flashWrapper.appendChild(S),
                (_ = C.IS_EDGE
                  ? [
                      'type="application/x-shockwave-flash"',
                      'data="' +
                        a.options.pluginPath +
                        a.options.filename +
                        '"',
                      'id="__' + a.id + '"',
                      'width="' + w + '"',
              ...
              (_ = [
                ...
                'src="' + a.options.pluginPath + a.options.filename + '"',
                'flashvars="' + y.join("&") + '"',
              ]),
                E
                ...
                (a.flashWrapper.innerHTML = "<embed " + _.join(" ") + ">");
            if (
              ((a.flashNode = a.flashWrapper.lastChild),
              (a.hide = function () {
                (r = !1), E && (a.flashNode.style.display = "none");
              }),
              (a.show = function () {
                (r = !0), E && (a.flashNode.style.display = "");
              }),
              (a.setSize = function (e, t) {
                (a.flashNode.style.width = e + "px"),
                  (a.flashNode.style.height = t + "px"),
                  null !== a.flashApi &&
                    "function" == typeof a.flashApi.fire_setSize &&
                    a.flashApi.fire_setSize(e, t);
              }),
              (a.destroy = function () {
                a.flashNode.remove();
              }),
        ...
        if (a.hasPluginVersion("flash", [10, 0, 0])) {
      ...
      { 17: 17, 19: 19, 2: 2, 20: 20, 3: 3, 6: 6, 8: 8, 9: 9 },
    ],
    13: [
      function (e, t, n) {
        "use strict";
              ...
              return (
                "undefined" != typeof flvjs
                  ...
                  : ((e.options.path =
                    ...
                    (S.promise =
                      S.promise || (0, a.loadScript)(e.options.path)),
            ...
            create: function (l, o, e) {
                  ...
                  r = function (a) {
                    ...
                    (d["get" + e] = function () {
                      ...
                      (d["set" + e] = function (e) {
                        if (
                          -1 ===
                          b.default.html5media.readOnlyProperties.indexOf(a)
                        )
                          if ("src" === a) {
                            if (
                              ((d[a] =
              ...
              if (
                ((E.default["__ready__" + s] = function (e) {
                  l.flvPlayer = u = e;
                  for (var t, i = flvjs.Events, n = 0, r = c.length; n < r; n++)
              ...
              return (
                l.dispatchEvent(g),
                l.promises.push(S.load({ options: h, configs: v, id: s })),
                d
              );
            },
          };
          ...
          l = {
            ...
            create: function (d, i, u) {
              ...
              for (
                ...
                o(r[l]);
              if (
                ((E.default["__ready__" + a] = function (e) {
                  d.hlsPlayer = c = e;
                  for (
                    var i = Hls.Events,
                      t = function (e) {
                ...
                for (; m < p; m++)
                  if (w.renderer.renderers[i.prefix].canPlayType(u[m].type)) {
              ...
              return (
                d.dispatchEvent(g),
                d.promises.push(S.load({ options: i.hls, id: a })),
                f
              );
            },
          };
        ...
        var o = {
          ...
          create: function (n, e, t) {
            ...
            void 0 === n.originalNode || null === n.originalNode
              ? ((a = g.default.createElement("audio")), n.appendChild(a))
              : (a = n.originalNode),
              a.setAttribute("id", r);
            for (
            ...
            for (
              ...
              (u = c[f]),
                a.addEventListener(u, function (e) {
                  if (i) {
            ...
            (a.setSize = function (e, t) {
              return (a.style.width = e + "px"), (a.style.height = t + "px"), a;
            }),
              (a.hide = function () {
                return (i = !1), (a.style.display = "none"), a;
              }),
              (a.show = function () {
                return (i = !0), (a.style.display = ""), a;
              });
            var p = 0,
              h = t.length;
            if (0 < h)
            ...
            a.addEventListener("error", function (e) {
              e &&
                ...
                i &&
                (p < h && void 0 !== t[p + 1]
                  ? ((a.src = t[p++].src), a.load(), a.play())
                  : n.generateError(
                      "Media error: Format(s) not supported or source(s) not found",
                      t
                    ));
            });
            var v = (0, b.createEvent)("rendererready", a);
            return n.dispatchEvent(v), a;
          },
        };
        (r.default.HtmlMediaElement = y.default.HtmlMediaElement = o),
          E.renderer.add(o);
      },
      { 17: 17, 19: 19, 2: 2, 3: 3, 8: 8, 9: 9 },
    ],
    16: [
      function (e, t, n) {
        "use strict";
        ...
        var T = {
            ...
            enqueueIframe: function (e) {
              (T.isLoaded = "undefined" != typeof YT && YT.loaded),
                T.isLoaded
                  ? T.createIframe(e)
                  : (T.loadIframeApi(), T.iframeQueue.push(e));
            },
            loadIframeApi: function () {
              T.isIframeStarted ||
                ((0, a.loadScript)("https://www.youtube.com/player_api"),
                (T.isIframeStarted = !0));
            },
            iFrameReady: function () {
              for (
                T.isLoaded = !0, T.isIframeLoaded = !0;
                0 < T.iframeQueue.length;
          ...
          l = {
            ...
            create: function (p, n, r) {
              ...
              (h.options = n),
                ...
                (h.mediaElement = p);
              for (
                var e = A.default.html5media.properties,
                  t = function (i) {
                    var e =
                      "" + i.substring(0, 1).toUpperCase() + i.substring(1);
                    (h["get" + e] = function () {
                        ...
                        if (null !== g)
                          switch (i) {
                            ...
                            case "muted":
                              e ? g.mute() : g.unMute(),
                                setTimeout(function () {
                                  var e = (0, j.createEvent)("volumechange", h);
                                  p.dispatchEvent(e);
                                }, 50);
                              break;
                            case "volume":
                            ...
                            case "playbackRate":
                              g.setPlaybackRate(e),
                                setTimeout(function () {
                                  var e = (0, j.createEvent)("ratechange", h);
                                  p.dispatchEvent(e);
                                }, 50);
                              break;
                            case "readyState":
                              var r = (0, j.createEvent)("canplay", h);
                              p.dispatchEvent(r);
                          }
                ...
                t(e[i]);
              for (
                var s = A.default.html5media.methods,
                  d = function (e) {
                    h[e] = function () {
                      if (null !== g)
                        switch (e) {
                          case "play":
                            return (a = !1), g.playVideo();
                          case "pause":
                            return (a = !0), g.pauseVideo();
                          case "load":
                            return null;
                        }
                    ...
                    onReady: function (e) {
                      ...
                      for (
                        var o = ["mouseover", "mouseout"],
                          l = function (e) {
                            var t = (0, j.createEvent)(e.type, h);
                            p.dispatchEvent(t);
                          },
                          s = 0,
                          d = o.length;
                    ...
                    onStateChange: function (e) {
                      ...
                      switch (e.data) {
                        ...
                        case 1:
                          ...
                          break;
                        case 2:
                          (t = ["pause"]), (a = !0), (o = !1), h.stopInterval();
                          break;
                        case 3:
                          (t = ["progress"]), (o = !1);
                          break;
              ...
              return (
                ...
                (h.startInterval = function () {
                  h.interval = setInterval(function () {
                    var e = (0, j.createEvent)("timeupdate", h);
                    p.dispatchEvent(e);
                  }, 250);
                }),
      ...
      { 18: 18, 19: 19, 2: 2, 20: 20, 3: 3, 8: 8, 9: 9 },
    ],
    17: [
      function (e, t, n) {
        "use strict";
        ...
        for (
          var l = (n.NAV = i.default.navigator),
            ...
            p = (n.IS_EDGE =
              ("msLaunchUri" in l) && !("documentMode" in a.default)),
          ...
          S = a.default.createElement(_[N]);
        var j = (n.SUPPORTS_NATIVE_HLS = g || (m && /edge/i.test(s))),
        ...
        var P = void 0 !== S.webkitRequestFullScreen,
          ...
          M = void 0;
        x
          ? (O = a.default.mozFullScreenEnabled)
          : L && (O = a.default.msFullscreenEnabled),
          h && (T = !1),
          C &&
            (P
            ...
            (n.cancelFullScreen = M =
              function () {
                P
                  ...
                  : L && a.default.msExitFullscreen();
              }));
        var R = (n.HAS_NATIVE_FULLSCREEN = F),
          D = (n.HAS_WEBKIT_NATIVE_FULLSCREEN = P),
          V = (n.HAS_MOZ_NATIVE_FULLSCREEN = x),
        ...
        (n.isFullScreen = k),
          ...
          (r.default.Features.supportsNativeHLS = j),
          ...
          (r.default.Features.hasWebkitNativeFullScreen = D),
          (r.default.Features.hasMozNativeFullScreen = V),
      ...
      function (e, t, n) {
        ...
        function l(e) {
          var t = e.getBoundingClientRect(),
            n = s.default.pageXOffset || i.default.documentElement.scrollLeft,
            r = s.default.pageYOffset || i.default.documentElement.scrollTop;
        ...
        function v(i) {
          ...
          s.default.requestAnimationFrame(function e(t) {
            var n = t - (l = l || t),
              r = parseFloat(1 - n / a, 2);
            (i.style.opacity = r < 0 ? 0 : r),
              a < n
                ? o && "function" == typeof o && o()
                : s.default.requestAnimationFrame(e);
          });
        }
        function g(i) {
          var a =
        ...
        function b(e, t, n, r) {
          var i = s.default.XMLHttpRequest
              ? new XMLHttpRequest()
    ...
    20: [
      function (e, t, n) {
        ...
        function s(e) {
          ...
          return (
            (t.innerHTML = '<a href="' + (0, o.escapeHTML)(e) + '">x</a>'),
            t.firstChild.href
          );
        }
        function d(e) {
  ...
  {},
  [21, 7, 6, 10, 15, 12, 11, 13, 14, 16]
);

$("audio").mediaelementplayer({
  features: ["playpause", "progress", "currenttime", "duration", "volume"],
  startVolume: 0.5,
});
